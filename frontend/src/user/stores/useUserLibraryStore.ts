...
type QuickFilter = 'all' | 'trending' | 'newest'
...
export const useUserLibraryStore = create<UserLibraryStore>((set) => ({
  documents: [],
  categories: [],
  activeCategory: null,
  ...
  clearTags: () =>
    set({ activeTags: [], activeCategory: null, activeSubCategory: null, quickFilter: 'all' }),
